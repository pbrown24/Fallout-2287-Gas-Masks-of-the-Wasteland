...
State UpdateState
	...
	Event OnBeginState(string asOldState)
		...
		Compact_F2_Gas_Mask.FormID = 0x0000A131
	   ...
	   string Outlawer_Outfits_ESP = "Outlawer Outfits.esp" const

	   Entry Armor_SASmaskA = new Entry
	   Armor_SASmaskA.PluginFile = Outlawer_Outfits_ESP
	   Armor_SASmaskA.FormID = 0x00000827
	   Armor_SASmaskA.TypeClass = ClassGasMask
	   Add(Armor_SASmaskA)

	   string Outlawer_MetroLL_ESP = "outlawer MetroLL.esp" const

	   Entry Clothes_MetroLL_Hansa_Gasmask = new Entry
	   Clothes_MetroLL_Hansa_Gasmask.PluginFile = Outlawer_MetroLL_ESP 
	   Clothes_MetroLL_Hansa_Gasmask.FormID = 0x0000095E
	   Clothes_MetroLL_Hansa_Gasmask.TypeClass = ClassGasMask
	   Add(Clothes_MetroLL_Hansa_Gasmask)
			
		Entry Clothes_MetroLL_Ranger_Faceguard = new Entry
		Clothes_MetroLL_Ranger_Faceguard.PluginFile = Outlawer_MetroLL_ESP 
		Clothes_MetroLL_Ranger_Faceguard.FormID = 0x000008A9
		Clothes_MetroLL_Ranger_Faceguard.TypeClass = ClassGasMask
		Add(Clothes_MetroLL_Ranger_Faceguard)
		
		Entry Clothes_MetroLL_Stalker_coverd = new Entry
        Clothes_MetroLL_Stalker_coverd.PluginFile = Outlawer_MetroLL_ESP
        Clothes_MetroLL_Stalker_coverd.FormID = 0x0000096F
        Clothes_MetroLL_Stalker_coverd.TypeClass = ClassGasMask
        Add(Clothes_MetroLL_Stalker_coverd)

	   string FV20_CHAINHEAD_Masks_ESP = "FV20_CHAINHEAD_Masks.esp"

	   Entry WarriorMask1 = new Entry
	   WarriorMask1.PluginFile = FV20_CHAINHEAD_Masks_ESP
	   WarriorMask1.FormID = 0x00000F9A
	   WarriorMask1.TypeClass = ClassGasMask
	   Add(WarriorMask1)

	   Entry WarriorMask2 = new Entry
	   WarriorMask2.PluginFile = FV20_CHAINHEAD_Masks_ESP
	   WarriorMask2.FormID = 0x00000F9C
	   WarriorMask2.TypeClass = ClassGasMask
	   Add(WarriorMask2)

	   Entry DoctorMask = new Entry
	   DoctorMask.PluginFile = FV20_CHAINHEAD_Masks_ESP
	   DoctorMask.FormID = 0x00000F9E
	   DoctorMask.TypeClass = ClassGasMask
	   Add(DoctorMask)

	   Entry MaidenMask = new Entry
	   MaidenMask.PluginFile = FV20_CHAINHEAD_Masks_ESP
	   MaidenMask.FormID = 0x00000FA0
	   MaidenMask.TypeClass = ClassGasMask
	   Add(MaidenMask)

	   Entry VetWarriorMask1 = new Entry
	   VetWarriorMask1.PluginFile = FV20_CHAINHEAD_Masks_ESP
	   VetWarriorMask1.FormID = 0x0000173B
	   VetWarriorMask1.TypeClass = ClassGasMask
	   Add(VetWarriorMask1)

	   Entry pestmask = new Entry
	   pestmask.PluginFile = FV20_CHAINHEAD_Masks_ESP
	   pestmask.FormID = 0x0000173D
	   pestmask.TypeClass = ClassGasMask
	   Add(pestmask)

	   Entry peacemaker = new Entry
	   peacemaker.PluginFile = FV20_CHAINHEAD_Masks_ESP
	   peacemaker.FormID = 0x00001ED8
	   peacemaker.TypeClass = ClassGasMask
	   Add(peacemaker)

	   Entry SkollMask = new Entry
	   SkollMask.PluginFile = FV20_CHAINHEAD_Masks_ESP
	   SkollMask.FormID = 0x00002E13
	   SkollMask.TypeClass = ClassGasMask
	   Add (SkollMask)

	   Entry IronClawMask1 = new Entry
	   IronClawMask1.PluginFile = FV20_CHAINHEAD_Masks_ESP
	   IronClawMask1.FormID = 0x00002E15
	   IronClawMask1.TypeClass = ClassGasMask
	   Add(IronClawMask1)

	   Entry spazmask1 = new Entry
	   spazmask1.PluginFile = FV20_CHAINHEAD_Masks_ESP
	   spazmask1.FormID = 0x00003D63
	   spazmask1.TypeClass = ClassGasMask
	   Add(spazmask1)

	   Entry sadistmask1 = new Entry
	   sadistmask1.PluginFile = FV20_CHAINHEAD_Masks_ESP
	   sadistmask1.FormID = 0x000044FE
	   sadistmask1.TypeClass = ClassGasMask
	   Add(sadistmask1)

	   Entry sadistmask2 = new Entry
	   sadistmask2.PluginFile = FV20_CHAINHEAD_Masks_ESP
	   sadistmask2.FormID = 0x00004500
	   sadistmask2.TypeClass = ClassGasMask
	   Add(sadistmask2)
	   
	   
	   string FV20_RSS_ESP = "FV20_RSS.esp" Const
		
		Entry hazmatmask = new Entry
		hazmatmask.PluginFile = FV20_RSS_ESP
		hazmatmask.FormID = 0x0000728F
		hazmatmask.TypeClass = ClassGasMask
		Add(hazmatmask)
		
		Entry hazmatuniform = new Entry
		hazmatuniform.PluginFile = FV20_RSS_ESP
		hazmatuniform.FormID = 0x00007291
		hazmatuniform.TypeClass = ClassGasMask
		Add(hazmatuniform)
		
		; AndromedaInitiative Armor
		string AndromedaInitiative_ESp = "AndromedaInitiative.esp"
		
		Entry Armor_PathfinderHelmet = new Entry
		Armor_PathfinderHelmet.PluginFile = AndromedaInitiative_esp
		Armor_PathfinderHelmet.FormID = 0x00000F9A
		Armor_PathfinderHelmet.TypeClass = ClassGasMask
		Add(Armor_PathfinderHelmet)
		
		; Lonesome Road Breathing Mask
		  string breathing_mask_ESP = "[F04] breathing mask.esp"

		  Entry breathingmask = new Entry
		  breathingmask.PluginFile = breathing_mask_ESP
		  breathingmask.FormID = 0x00000F9A
		  breathingmask.TypeClass = ClassGasMask
		  Add(breathingmask)

		  string Wolfenstein_ESP = "Wolfenstein.esp"

		  Entry wolfensteininfant2helm = new Entry
		  wolfensteininfant2helm.PluginFile = Wolfenstein_ESP
		  wolfensteininfant2helm.FormID = 0x00002E0A
		  wolfensteininfant2helm.TypeClass = ClassGasMask
		  Add(wolfensteininfant2helm)

		  Entry wolfensteincommandohelm = new Entry
		  wolfensteincommandohelm.PluginFile = Wolfenstein_ESP
		  wolfensteincommandohelm.FormID = 0x000044D2
		  wolfensteincommandohelm.TypeClass = ClassGasMask
		  Add(wolfensteincommandohelm)
		...
		string MetroArmorPorts_ESP = "MetroArmorPorts.esp" const
		
		Entry Armor_rangerhelmet = new Entry
		Armor_rangerhelmet.PluginFile = MetroArmorPorts_ESP
		Armor_rangerhelmet.FormID = 0x00000805
		Armor_rangerhelmet.TypeClass = ClassGasMask
		Add(Armor_rangerhelmet)
		
		Entry Armor_rangerhelmetwithnightvisiongoggles = new Entry
		Armor_rangerhelmetwithnightvisiongoggles.PluginFile = MetroArmorPorts_ESP
		Armor_rangerhelmetwithnightvisiongoggles.FormID = 0x00000800
		Armor_rangerhelmetwithnightvisiongoggles.TypeClass = ClassGasMask
		Add(Armor_rangerhelmetwithnightvisiongoggles)
