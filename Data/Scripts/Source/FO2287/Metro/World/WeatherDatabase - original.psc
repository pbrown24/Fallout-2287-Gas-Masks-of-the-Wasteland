...
State UpdateState
	...
	Event OnBeginState(string asOldState)
		...
		NACGiantRedStorm.PluginFile = NAC_ESM
		NACGiantRedStorm.FormID = 0x00087F86
		NACGiantRedStorm.TypeClass = ClassDust
		Add(NACGiantRedStorm)
		
		Entry GSNACGiantRedStormOVC = new Entry
		NACGiantRedStormOVC.PluginFile = NAC_ESM
		NACGiantRedStormOVC.FormID = 0x00087F87
		NACGiantRedStormOVC.TypeClass = ClassSnow
		Add(NACGiantRedStormOVC)
		
		Entry NACGiantRedStormSnow = new Entry
		NACGiantRedStormSnow.PluginFile = NAC_ESM
		NACGiantRedStormSnow.FormID = 0x000008CA
		NACGiantRedStormSnow.TypeClass = ClassSnow
		Add(NACGiantRedStormSnow)
		...
		Entry NACSnowyFoggy = new Entry
		NACSnowyFoggy.PluginFile = NAC_ESM
		NACSnowyFoggy.FormID = 0x0004E158
		NACSnowyFoggy.TypeClass = ClassSnow
		Add(NACSnowyFoggy)
		
		Entry NACClearColdSnow = new Entry
		NACClearColdSnow.PluginFile = NAC_ESM
		NACClearColdSnow.FormID = 0x000562AC
		NACClearColdSnow.TypeClass = ClassSnow
		Add(NACClearColdSnow)
		
		Entry NACSnowStorm = new Entry
		NACSnowStorm.PluginFile = NAC_ESM
		NACSnowStorm.FormID = 0x00054BDE
